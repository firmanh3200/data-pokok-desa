...
if wilayah == 'Bogor':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0205{kodeterpilih}/3'
...
if wilayah == 'Sukabumi':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0206{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Cianjur':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0207{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Bandung': 
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0208{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Garut':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0211{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Tasikmalaya':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0212{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Ciamis':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0214{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kuningan':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0215{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Cirebon':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0217{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Majalengka':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0216{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Sumedang':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0210{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Indramayu':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0218{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Subang':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0219{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Purwakarta':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0220{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Karawang':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0221{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Bekasi':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0222{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Bandung Barat':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0223{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Pangandaran':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0225{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Bogor':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0261{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Sukabumi':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0262{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Bandung':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0260{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Cirebon':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0263{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Bekasi':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0265{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Depok':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0266{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Cimahi':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0267{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Tasikmalaya':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0268{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
...
if wilayah == 'Kota Banjar':
    ...
    url2 = f'https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/0269{kodeterpilih}/3'
    response2 = requests.get(url2)
    soup2 = BeautifulSoup(response2.content, 'html.parser')
