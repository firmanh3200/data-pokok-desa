...
st.title("Pendapatan Desa")
st.warning(f"Sumber: https://portaldatadesa.jabarprov.go.id/index-profile-desa/Ekonomi/Pendapatan-Desa, Kondisi: {tanggal_hari_ini}")
...
if tahunterpilih:
    ...
    def fetch_data(page, limit=25):
        url = f"https://portaldatadesa.jabarprov.go.id/api/idm/idmdataidentitas/v2?sub_name=SUMBER%20PENDAPATAN%20DESA&tahun={tahunterpilih}&order=asc&orderby=id_desa&page={page}&limit={limit}"
