...
if tahun and semester:
    ...
    with st.container(border=True):
        # Ambil data dari URL
        url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=0&kode_wilayah=000000&semester_id={tahun}{semester}'
...
if wilayah == 'Jawa Barat':
    with st.container(border=True):
        # Ambil data dari URL
        url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=1&kode_wilayah=020000&semester_id={tahun}{semester}'
        response = requests.get(url)
        #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Bogor':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=020500&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Sukabumi':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=020600&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Cianjur':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=020700&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Bandung': 
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=020800&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Garut':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021100&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Tasikmalaya':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021200&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Ciamis':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021400&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kuningan':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021500&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Cirebon':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021700&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Majalengka':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021600&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Sumedang':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021000&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Indramayu':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021800&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Subang':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=021900&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Purwakarta':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=022000&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Karawang':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=022100&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Bekasi':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=022200&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Bandung Barat':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=022300&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Pangandaran':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=022500&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Bogor':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026100&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Sukabumi':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026200&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Bandung':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026000&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Cirebon':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026300&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Bekasi':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026500&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Depok':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026600&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Cimahi':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026700&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Tasikmalaya':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026800&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
...
if wilayah == 'Kota Banjar':
    url = f'https://dapo.kemdikbud.go.id/rekap/dataGuru?id_level_wilayah=2&kode_wilayah=026900&semester_id={tahun}{semester}'
    response = requests.get(url)
    #soup = BeautifulSoup(response.content, 'html.parser')
